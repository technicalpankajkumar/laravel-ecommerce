        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin_imageUpdate')}}" enctype="multipart/form-data">
                            @csrf
                                <div class="col">
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('admin_profileUpdate')}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <div class="col">
