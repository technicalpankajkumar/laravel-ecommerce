        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    @endif
                    <!-- Product image-->
                    <img class="card-img-top" src="{{url('/products').'/'.$product->image}}" alt="{{$product->name}}" height="250px" width="180px"/>
                    <!-- Product details-->
            ...
            <div class="d-grid gap-2 col-6 mx-auto ">
                <a href="{{route('view_products')}}" class="btn btn-outline-dark">View All</a>
            </div>
        </div>
    </div>
</section> 
